...
export default function About() {
  ...
  return (
    <div className="flex flex-col h-screen text-center bg-[url('/bg.gif')] bg-cover bg-no-repeat text-white">
      ...
      <div className="basis-9/12 font-normal flex flex-col items-center justify-center border-2 m-8 rounded-3xl bg-gray-500/20">
        ...
        <a href="/cvJoanMas.pdf" download="cvJoanMas" className=" bg-violet-600 flex items-center justify-center border-2 rounded-3xl h-8 w-24 m-2">
          My CV
        </a>
      </div>
